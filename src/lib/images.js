export const images = {
  ...
  image2: { id: 2, path: '/Assets/movies/Extraction_22.webp' },
  image3: { id: 3, path: '/Assets/movies/Extraction_23.webp' },
  image4: { id: 4, path: '/Assets/movies/Game of Thrones (2011).webp' },
  image5: { id: 5, path: '/Assets/movies/Hypnotic 2023 Movies Poster Film Wall Art Full Size.webp' },
  image6: { id: 6, path: '/Assets/movies/John Wick Chapter 4 full movies 123 hd(1).webp' },
  //image7: { id: 7, path: '/Assets/movies/Missionimpossibledeadreckoning12.jpg' },
  //image8: { id: 8, path: '/Assets/movies/Operation Fortune Ruse de guerre.jpg' },
  //image9: { id: 9, path: '/Assets/movies/oppenheimer.jpg' },
  image10: { id: 10, path: '/Assets/movies/Participamos de um bate-papo exclusivo com John Turturro, de “Batman”.webp' },
  //image11: { id: 11, path: '/Assets/movies/sisu.jpg' },
  //image12: { id: 12, path: '/Assets/movies/The Godfather (1972) [1088 x 1640].jpg' },
  //image13: { id: 13, path: '/Assets/movies/wwz.jpg' },

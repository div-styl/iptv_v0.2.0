      ...
      <div class="mx-auto mt-8 grid max-w-xl divide-y divide-neutral-200">
        <div class="py-5">
          <details class="group">
            ...
            >
              <span class="font-semibold"> How open A refund claim </span>
        ...
        <div class="py-5">
          <details class="group">
            <summary
              class="flex cursor-pointer list-none items-center justify-between font-medium"
            >
              <span class="font-semibold"> Available Payment Options</span>
              <span class="transition group-open:rotate-180">
                <svg
                  fill="none"
                  height="24"
        ...
        <div class="py-5">
          <details class="group">
            <summary
              class="flex cursor-pointer list-none items-center justify-between font-medium"
            >
              <span class="font-semibold"> Which devices are supported</span>
              <span class="transition group-open:rotate-180">
                <svg
                  fill="none"
                  height="24"
        ...
        <div class="py-5">
          <details class="group">
            <summary
              class="flex cursor-pointer list-none items-center justify-between font-medium"
            >
              <span class="font-semibold"> Recommanded Internet Speed</span>
              <span class="transition group-open:rotate-180">
                <svg
                  fill="none"
                  height="24"
          ...
          <details class="group">
            ...
            >
              <span class="font-semibold">
                Can I use the IPTV in many devices</span
              >
              <span class="transition group-open:rotate-180">
                <svg
                  fill="none"
        ...
        <div class="py-5">
          <details class="group">
            <summary
              class="flex cursor-pointer list-none items-center justify-between font-medium"
            >
              <span class="font-semibold"> How can I get my trial</span>
              <span class="transition group-open:rotate-180">
                <svg
                  fill="none"
                  height="24"

...
<main class="text-white leading-7">
  ...
  <p class="text-sm font-medium">
    ...
    generated with the help of <a href="https://www.gdprprivacynotice.com/"
    class="text-blue-600 decoration-blue-600
    hover:underline underline-offset-2"
  ...
  <h2 class="text-2xl font-semibold">Privacy Policies</h2>
  ...
  <h2 class="text-2xl font-semibold">Online Privacy Policy Only</h2>

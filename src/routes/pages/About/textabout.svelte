...
>
  ...
  <p class="text-white font-medium md:text-xl text-sm ">
    ...
    We hope you enjoy our Digital product as much as we enjoy offering them to
    you.
  </p>
  ...
  <p  class="text-white font-bold md:text-xl text-sm text-center ">
    Thanks For Visiting Our Site<br /><br />
    <span  class=" font-bold md:text-xl  text-center text-[#FF8913] text-xl "
